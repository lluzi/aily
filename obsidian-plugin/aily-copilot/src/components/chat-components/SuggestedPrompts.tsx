...
const PROMPT_KEYS: Record<ChainType, Array<keyof typeof SUGGESTED_PROMPTS>> = {
  [ChainType.AILY_CHAIN]: ["qaVault", "copilotPlus", "activeNote"],
    ...
    <div className="tw-flex tw-flex-col tw-gap-4">
      ...
      {chainType === ChainType.VAULT_QA_CHAIN && (
        <div className="tw-rounded-md tw-border tw-border-solid tw-border-border tw-p-2 tw-text-sm">
          Please note that DIKIWI retrieval works best when questions contain keywords and
          ...
          <div className="tw-rounded-md tw-border tw-border-solid tw-border-border tw-p-2 tw-text-sm">
            <div>
              ...
              <span className="tw-text-accent">
                Copilot command: Index (refresh) vault for DIKIWI
              </span>{" "}
              to update the index.
            </div>
          </div>

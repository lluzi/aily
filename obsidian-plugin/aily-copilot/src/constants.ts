...
export const BUILTIN_CHAT_MODELS: CustomModel[] = [
  ...
  {
    name: ChatModels.KIMI_K2_6,
    provider: ChatModelProviders.KIMI,
    enabled: true,
    isBuiltIn: true,
    core: true,
    projectEnabled: true,
...
export enum EmbeddingModels {
  ...
  DEEPSEEK_EMBEDDING = "deepseek-embedding",
...
export const BUILTIN_EMBEDDING_MODELS: CustomModel[] = [
  {
    name: EmbeddingModels.DEEPSEEK_EMBEDDING,
    provider: EmbeddingModelProviders.DEEPSEEK,
    enabled: true,
    isBuiltIn: true,
  ...
  {
    name: EmbeddingModels.KIMI_EMBEDDING,
    provider: EmbeddingModelProviders.KIMI,
    enabled: true,
    isBuiltIn: true,
    isEmbeddingModel: true,
    core: true,
...
export const ProviderInfo: Record<Provider, ProviderMetadata> = {
  ...
  [ChatModelProviders.KIMI]: {
    label: "Kimi",
    host: "https://api.moonshot.cn/v1",
    curlBaseURL: "https://api.moonshot.cn/v1",
    keyManagementURL: "https://platform.moonshot.cn/console/api-keys",
    listModelURL: "https://api.moonshot.cn/v1/models",
    testModel: ChatModels.KIMI_K2_6,
  },
  [ChatModelProviders.DEEPSEEK]: {
    ...
    testModel: ChatModels.DEEPSEEK_V4_PRO,
  },
...
export const COMMAND_IDS = {
  ...
  RUN_END_TO_END_VALUE_WORKFLOW: "run-end-to-end-value-workflow",
} as const;
...
export const COMMAND_NAMES: Record<CommandId, string> = {
  ...
  [COMMAND_IDS.RUN_END_TO_END_VALUE_WORKFLOW]: "Run End-To-End Value Workflow",
};
...
export const COMMAND_ICONS: Partial<Record<CommandId, string>> = {
  ...
  [COMMAND_IDS.RUN_END_TO_END_VALUE_WORKFLOW]: "workflow",
};
...
export const RESTRICTION_MESSAGES = {
  NON_MARKDOWN_FILES_RESTRICTED: "Non-markdown files are available in Chat mode.",
  URL_PROCESSING_RESTRICTED: "URL processing is available in Chat mode.",
...
export const DEFAULT_SETTINGS: CopilotSettings = {
  ...
  defaultModelKey: ChatModels.DEEPSEEK_V4_PRO + "|" + ChatModelProviders.DEEPSEEK,
  embeddingModelKey: EmbeddingModels.DEEPSEEK_EMBEDDING + "|" + EmbeddingModelProviders.DEEPSEEK,
  ...
  ailyApiBaseUrl: "http://127.0.0.1:8000",
  ailyApiToken: "",
  ailyUseLlm: true,
  dikiwiAutoTrigger: false,
  dikiwiAutoTriggerFileExtensions: "md,pdf,docx,pptx,txt",
  dikiwiAutoTriggerInclusions: "",
  dikiwiAutoTriggerExclusions:
    ".obsidian,copilot,01-Data,02-Information,03-Knowledge,04-Insight,05-Wisdom,06-Impact,07-Research,08-Evaluations,09-Business-Plans,10-Dossiers,99-MOC,99-System",

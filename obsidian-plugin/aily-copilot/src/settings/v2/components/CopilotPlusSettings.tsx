      ...
      <section className="tw-flex tw-flex-col tw-gap-4">
        ...
        <div className="tw-flex tw-flex-col tw-gap-4">
          ...
          <SettingItem
            ...
            description="Enable autonomous agent controls in Chat. The AI can reason step-by-step and decide which tools to use automatically."
          ...
          {isSelfHostEligible && (
            <>
              <div className="tw-flex tw-items-center tw-gap-1.5 tw-pt-4 tw-text-xl tw-font-semibold">
                Self-Host Mode
                <HelpTooltip content="Optional local infrastructure. Chat capabilities are already included." />
              </div>
                    ...
                    <HelpTooltip
                      content={
                        <div className="tw-flex tw-max-w-96 tw-flex-col tw-gap-2 tw-py-4">
                          ...
                          <div className="tw-text-xs tw-text-muted">
                            This is optional and does not control Chat access.
                          </div>
                        </div>
                      }
                    />
